# Nexlayer — alertmanager

**Live:** [https://relaxed-weasel-alertmanager.cloud.nexlayer.ai](https://relaxed-weasel-alertmanager.cloud.nexlayer.ai)  
...
**alertmanager** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/prom/alertmanager:latest
    path: /
    servicePorts:
    - 9093
    volumes:
